    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div style={{
                ...
                {
                    showModal && (
                        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm rounded-lg overflow-y-auto py-10">
                            <div className="bg-white p-6 rounded-lg shadow-xl w-[600px] max-h-[90vh] overflow-y-auto">
                                <h3 className="text-xl font-bold mb-6 text-gray-800">Créer une nouvelle visite</h3>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Heure de la visite</label>
                                        <input
                                            type="time"
                                            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                ...
                                <div className="mb-4">
                                    ...
                                    <select
                                        className="w-full border border-gray-300 rounded px-3 py-2 bg-white mb-2"
                                        value={newEvent.givenSampleName && newEvent.givenSampleBatch ? `${newEvent.givenSampleName}|${newEvent.givenSampleBatch}` : ""}
                                        onChange={(e) => {
                                            const val = e.target.value;
                                            if (!val) {
                                                setNewEvent({ ...newEvent, givenSampleName: '', givenSampleBatch: '' });
                                            } else {
                                ...
                                <div className="mb-6">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Détails de la tâche</label>
                                    <textarea
                                ...
                                <div className="flex justify-end gap-3 sticky bottom-0 bg-white pt-4 border-t border-gray-100">
                                    <button
                                        ...
                                        className="px-5 py-2.5 text-gray-600 hover:bg-gray-50 rounded-md transition-colors font-medium"
                                    >
                                        Annuler
                                    </button>
                                    <button
                                        ...
                                        className={`px-5 py-2.5 text-white rounded-md transition-colors font-medium shadow-sm ${isProcessing ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
                                    >
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-xl font-bold text-gray-800">
                                Résumé de la visite {isReadOnly && <span className="text-sm font-normal text-yellow-600 bg-yellow-50 px-2 py-0.5 rounded ml-2">(Lecture Seule)</span>}
                            </h3>
                            <button
                        ...
                        {selectedEvent.givenSampleName && (
                            <div className="mb-2 p-3 bg-green-50 text-green-800 rounded-md border border-green-100 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span>📦 Échantillon : <strong>{selectedEvent.givenSampleName}</strong></span>
                                </div>
                        ...
                        <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                            <div>
                                {!isReadOnly && (
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-red-50 text-red-600 rounded-md hover:bg-red-100 transition-colors font-medium flex items-center gap-2"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                                        </svg>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={isProcessing}
                                    className={`px-5 py-2.5 text-white rounded-md transition-colors font-medium shadow-sm ${isReadOnly ? 'hidden' : ''} ${isProcessing ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'}`}
                                >
                                    {isProcessing ? 'Enregistrement...' : 'Sauvegarder les modifications'}
                                </button>
                            </div>
                        </div>
