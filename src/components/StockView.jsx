...
export default function StockView() {
    ...
    const [activeTab] = useState('sample'); // Simplified to only samples
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <div className={`mb-8 p-6 rounded-lg border shadow-sm ${activeTab === 'sample' ? 'bg-green-50 border-green-100' : 'bg-blue-50 border-blue-100'}`}>
                <h3 className="text-lg font-semibold mb-4 text-gray-700">
                    Ajouter un échantillon (Médicament)
                </h3>
                {message && (
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">N° Lot</th>
